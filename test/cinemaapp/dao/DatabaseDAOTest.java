    ...
    private static void createSchema() throws SQLException {
        try (Statement st = conn.createStatement()) {
            for (String sql : new String[]{
                ...
                "CREATE TABLE Booking (bookingCode VARCHAR(20) NOT NULL PRIMARY KEY, bookingDate DATE NOT NULL, totalPrice FLOAT NOT NULL, username VARCHAR(50) NOT NULL, CONSTRAINT fk_t_b_acc FOREIGN KEY (username) REFERENCES Account(username))",
